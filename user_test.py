...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_user = User("Nicholas", "Owino", "0728671041", "nicholas@ms.com")  # create user object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.email, "nicholas@ms.com")
    ...
    def test_save_multiple_users(self):
        ...
        test_user = User("Test", "user", "0728671041", "test@user.com")  # new user
